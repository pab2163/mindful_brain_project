...
prompt = {'Enter subject name','Run (01)'};
def={'XXX','01'};
answer = inputdlg(prompt, 'Experimental setup information',1,def);
...
'saving data- wait!'
save(['sub-remind' subName '_task-cpt_run-' num2str(runNo) '_prac.mat'],'data', 'response','ttt','FHR','Rate','Prob','Task','Scram', 'framesper', 'numberoftrials', 'subName','starttime','endtime','x_size','y_size');
...
tsv_name = strcat('sub-remind', subName, '_task-cpt_run-', num2str(runNo), '_prac.txt'); % check sesName and runNo
