...
foreach max_consec ( 2 3)
   foreach max_isi ( 6 8 10)
      ...
      set outdir=stim_results/max_consec${max_consec}_isi_max_${max_isi}_seed_$seed
      set LCfile = NSD_sums_${max_consec}_${max_isi}      # file to store norm. std. dev. sums in
