#!/bin/tcsh
set iterations  = 2        # number of iterations to compare
...
set tr          = 1.2   # used in 3dDeconvolve, if not make_random_timing.py
set seed        = $1       # initial random seed
set outdir      = stim_results/max_consec2_ISI_max_8.$seed  # directory that all results are under
set LCfile      = NSD_sums      # file to store norm. std. dev. sums in
...
set tr          = 1.2   # used in 3dDeconvolve, if not make_random_timing.py
set seed        = $1       # initial random seed
set outdir      = stim_results/max_consec3_ISI_max_10.$seed  # directory that all results are under
set LCfile      = NSD_sums      # file to store norm. std. dev. sums in
...
foreach iter (`count -digits 4 1 $iterations`)
 ...
 make_random_timing.py -num_runs 10 -run_time 32  \
    ...
    -prefix stimes.$iter               \
    -max_consec 3 3                         \
    -add_timing_class ISI1 0.5 -1 10		 \
    -add_timing_class word 2.5 \
    -add_stim_class pos_${iter}  3  word  ISI1               \
    -add_stim_class neg_${iter}  3  word  ISI1               \
    -show_timing_stats \
...
set tr          = 1.2   # used in 3dDeconvolve, if not make_random_timing.py
set seed        = $1       # initial random seed
set outdir      = stim_results/max_consec2_ISI_max_10.$seed  # directory that all results are under
set LCfile      = NSD_sums      # file to store norm. std. dev. sums in
