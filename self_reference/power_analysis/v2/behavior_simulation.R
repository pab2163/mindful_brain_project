...
#odds_ratio_15 = (mean_negative_endorse_post_15/(1-mean_negative_endorse_post_15)) / (mean_negative_endorse_pre/(1-mean_negative_endorse_pre))
#odds_ratio_30 = (mean_negative_endorse_post_30/(1-mean_negative_endorse_post_30)) / (mean_negative_endorse_pre/(1-mean_negative_endorse_pre))


g= run_one_simulation(iter=1, mean_negative_endorse_change_difference = .12)
g$example_plot
